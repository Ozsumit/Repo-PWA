...
const Footer: React.FC<FooterProps> = ({ items }) => {
  return (
    <footer className="w-[97vw] lg:w-full py-6 bg-black backdrop:blur-md sm:pb-16 z-50 font-mono border border-white dark:border-white/[0.2] text-gray-400 p-4 rounded-lg justify-center flex flex-col items-center">
