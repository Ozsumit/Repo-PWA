      ...
      <div className="mb-4 w-10/12 lg:w-auto relative">
        <form onSubmit={handleSubmit} className="relative">
          <input
            ...
            className="w-full lg:w-96 h-12 text-white bg-black rounded-md border border-white/20 px-4 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-neutral-50 focus:border-transparent transition duration-200 ease-in-out"
          />
          {searchTerm && (
            <button
              type="button"
