...
const specialItems: SpecialItem[] = [
  ...
  },
  {
    id: "frostBonus",
    name: "Frost Bonus",
    description: "Freezes auto-clicker cost increase for 45 seconds",
    cost: 450000,
  ...
  },
  {
    ...
    effect: (state) => ({
      ...
      autoClickerCount: state.autoClickerCount * 7,
      ...
      <div className="bg-black p-4 rounded-lg shadow-lg w-full md:w-144 text-white mx-auto border-2 border-accenth">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2 mb-4">
          {specialItems.map((item) => {
            ...
            // No need to calculate new cost here again, just display the current cost from gameState
            const itemCost =
            ...
            return (
              ...
              >
                <div className="flex flex-col justify-center items-center">
                  ...
                  <span className="text-yellow-400">{itemCost} coins</span>
